# 7ffc82e7-6d59-449a-9fe3-a9ec6f091ab1 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `riva-bike-404.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `riva-bike-404.html`
...
- A single self-contained `riva-bike-404.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `riva-bike-404.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `riva-bike-404.html`
- `riva-bike-dashboard.html`
- `riva-bike-forgot.html`
- `riva-bike-landing-v1.html`
- `riva-bike-landing-v2.html`
- `riva-bike-landing-v3.html`
- `riva-bike-landing.html`
- `riva-bike-login.html`
...
- `drawing-2026-08-27T22-10-01-723Z.png`
- `drawing-2026-08-27T22-10-27-538Z.png`
- `ejemplo-1.png`
- `ejemplo-2.png`
- `landing-refine-modals.md`
- `opendesign-brief-dashboard.md`
- `opendesign-brief-landing.md`
- `plan-riva-bike.md`

## Coding checklist for AI tools
1. Inspect `riva-bike-404.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
