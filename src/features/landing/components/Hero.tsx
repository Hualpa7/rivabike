...
export function Hero() {
  ...
  return (
    <section id="inicio" className="relative flex min-h-[100svh] flex-col justify-end overflow-hidden">
      {bg ? (
        <div
      ...
      <div className="absolute right-[2%] top-1/2 hidden w-[min(42vw,520px)] -translate-y-1/2 md:block">
        <motion.div
        ...
        >
          ...
          <div className="h-full w-full overflow-hidden rounded-full">
            {bg ? (
              <img src={bg} alt="Bicicleta del taller" className="h-full w-full object-cover" />
            ) : (
      ...
      <div className="relative mx-auto w-full max-w-[1120px] px-6 pb-16 pt-32 md:pb-20">
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.7 }}
          className="font-mono text-xs font-extrabold uppercase tracking-[0.16em] text-pink"
        >
          {eyebrow}
        </motion.p>
        <motion.h1
          ...
          className="mt-4 max-w-[15ch] font-display text-5xl font-bold leading-[0.98] tracking-[-0.03em] text-white md:text-[88px]"
        >
          {titulo}
        </motion.h1>
        ...
        {reviews ? (
          <motion.div
            ...
            className="mt-6 inline-flex items-center gap-2.5 rounded-pill border border-white/25 bg-ink/25 px-4 py-2 backdrop-blur-md"
          >
